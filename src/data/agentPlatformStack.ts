...
export const ENGAGEMENT_OPTIONS: readonly EngagementOption[] = [
  ...
  { id: 'architect', num: '03', label: 'Talk to an architect',  pitch: '30 min unfiltered. Regulatory, integrations, constraints.', href: 'mailto:sales@attentions.ai', ctaText: 'Book call' },
] as const;
