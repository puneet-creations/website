...
const clients = [
  {
    icon: Truck,
    label: 'Logistics group · Dubai · 20+ business units',
  ...
  },
  {
    ...
    attribution: 'Quality Director · Global automotive maker',
    proof: '1.2M reports indexed',
  },
  {
    icon: Stethoscope,
    label: 'Dental group · 38 clinics',
    title: 'Every consult.',
    titleAccent: 'Every call.',
    metric: '$100K+',
    metricLabel: 'recovered per clinic / year',
    bullets: [
      'Doctor’s Notes · on-prem ASR · ICD-10 synced to records',
      'Patient Call Agent · every call answered 24/7',
      '~2 hours given back to each doctor per day',
    ],
    quote: 'We cleared CISO and DPO review in one meeting. Nothing we do ever leaves the data centre.',
    attribution: 'CISO · Multi-state dental group',
